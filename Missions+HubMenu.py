...
from Mission_Code import mission_code_left_side_1,mission_code_left_side_2, mission_code_left_side_3, home_transfer_left, home_transfer_right,mission_code_right_side_1
